...
export class Formulario2Service {
  ...
  readonly URL_API = 'http://localhost:3000/api/form2';
  readonly URL_AP2 = 'http://localhost:3000/api/export1';

  constructor (private http: HttpClient){
    this.selectedForm1 = new Formulario2();
    this.selectedExoport1= new Export1();
    this.post_to_be_edited = new Formulario2();
  ...
  getForm1(_id: String){
    return this.http.get('http://localhost:3000/api/form2/id' + `/${_id}`)
  }

  postForm(form1: Formulario2) {
    console.log(form1);
  ...
  notifyPostEdit(){
	...
	setPostToEdit(user: Formulario2){
